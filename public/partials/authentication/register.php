...
<div class="et_pb_contact">
    <form class="et_pb_contact_form clearfix" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
        ...
        <p class=" et_pb_contact_field ui-sortable et_pb_contact_field_half">
            ...
            <input type="text" name="first_name" id="first_name"  onblur="validate()" class="input <?php if(!empty($errors['firstName'])) { echo "et_contact_error"; } ?>"  data-field_type="input" placeholder="First Name" value="<?php if(!empty($_REQUEST['first_name'])) { echo $_REQUEST['first_name']; } ?>">
        ...
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_half et_pb_contact_field_last">
            ...
            <input type="text" name="last_name" id="last_name" onblur="validate()"  class="input <?php if(!empty($errors['lastName'])) { echo "et_contact_error"; } ?>" data-required_mark="required" placeholder="Last Name" value="<?php if(!empty($_REQUEST['last_name'])) { echo $_REQUEST['last_name']; } ?>">
        ...
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_half">
            ...
            <input type="password" name="password" id="password"  onblur="validate()" class="input <?php if(!empty($errors['password'])) { echo "et_contact_error"; } ?>" data-required_mark="required" placeholder="Password" value="">
        ...
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_half et_pb_contact_field_last">
            ...
            <input type="password" name="confirm_password" id="confirm_password" onblur="validate()" class="input <?php if(!empty($errors['confirmPassword'])) { echo "et_contact_error"; } ?>" data-required_mark="required" placeholder="Confirm Password" value="">
        ...
        <p class=" et_pb_contact_field ui-sortable et_pb_contact_field_half">
            ...
            <input type="text" name="spouse_first_name" id="spouse_first_name" onblur="validatePartner()" class="input <?php if(!empty($errors['spouseFirstName'])) { echo $errors['spouseFirstName']; } ?>" data-required_mark="required" placeholder="Spouse First Name" value="<?php if(!empty($_REQUEST['spouse_first_name'])) { echo $_REQUEST['spouse_first_name']; } ?>">
        ...
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_half et_pb_contact_field_last">
            ...
            <input type="text" name="spouse_last_name" id="spouse_last_name" onblur="validatePartner()" class="input <?php if(!empty($errors['spouseLastName'])) { echo $errors['spouseLastName']; } ?>" data-required_mark="required" placeholder="Spouse Last Name" value="<?php if(!empty($_REQUEST['spouse_last_name'])) { echo $_REQUEST['spouse_last_name']; } ?>">
        ...
        <p class=" et_pb_contact_field ui-sortable et_pb_contact_field_half" data-type="email">
            ...
            <input type="email" name="spouse_email" id="spouse_email" onblur="validatePartner()" class="input <?php if(!empty($errors['spouseEmail'])) { echo "et_contact_error"; } ?>" data-required_mark="required"  data-field_type="email" placeholder="Spouse Email" value="<?php if(!empty($_REQUEST['spouse_email'])) { echo $_REQUEST['spouse_email']; } ?>">
        ...
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_half et_pb_contact_field_last">
            ...
            <input type="text" id="partner_member_phone_no" oninput="this.value = this.value.replace(/[^0-9-+() ]/g, '').replace(/(\..*)\./g, '$1');"  name="secondary_mobile_no" maxlength="15" class="input" data-required_mark="required" placeholder="Spouse Mobile No" value="<?php if(!empty($_REQUEST['secondary_mobile_no'])) { echo $_REQUEST['secondary_mobile_no']; } ?>">
        ...
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_half">
            ...
            <input type="password" name="spouse_password" id="spouse_password" onblur="validatePartner()" class="input <?php if(!empty($errors['spousePassword'])) { echo "et_contact_error"; } ?>" data-required_mark="required" placeholder="Spouse Password" value="">
        ...
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_half et_pb_contact_field_last">
            ...
            <input type="password" name="spouse_confirm_password" id="spouse_confirm_password" onblur="validatePartner()" class="input <?php if(!empty($errors['confirmSpousePassword'])) { echo "et_contact_error"; } ?>" data-required_mark="required" placeholder="Spouse Confirm Password" value="">
        ...
        <textarea name="address_line_1" id="address_line_1"  onblur="validate()" class="input <?php if(!empty($errors['addressLine1'])) { echo "et_contact_error"; } ?>" data-required_mark="required" data-field_type="text" placeholder="Address Line 1"><?php if(!empty($_REQUEST['address_line_1'])) { echo $_REQUEST['address_line_1']; } ?></textarea>
        ...
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_half">
            ...
            <select name="country" id="country" onchange="getstate()" onblur="validate()" class="et_pb_contact_select input <?php if(!empty($errors['country'])) { echo "et_contact_error"; } ?>" data-required_mark="required" placeholder="Country">
        ...
        <p class=" et_pb_contact_field ui-sortable et_pb_contact_field_half et_pb_contact_field_last">
            ...
            <select name="state" id="state" onblur="validate()" class="et_pb_contact_select input" data-required_mark="required" placeholder="State">
            </select>
        </p>

        <p class=" et_pb_contact_field ui-sortable et_pb_contact_field_half">
            <label for="" class="required_field">City</label>
            <input type="text" name="city" id="city" onblur="validate()" class="input <?php if(!empty($errors['city'])) { echo "et_contact_error"; } ?>" data-required_mark="required" placeholder="City" value="<?php if(!empty($_REQUEST['city'])) { echo $_REQUEST['city']; } ?>">
            <span class="error_messages"><?php if(!empty($errors['city'])) { echo $errors['city']; } ?></span>
        </p>
            
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_half et_pb_contact_field_last">
            <label for="" class="required_field">Postal Code</label>
            <input type="text" id="postal_code" onblur="validate()" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="postal_code" class="input <?php if(!empty($errors['postalCode'])) { echo "et_contact_error"; } ?>" data-required_mark="required" placeholder="Postal Code" value="<?php if(!empty($_REQUEST['postal_code'])) { echo $_REQUEST['postal_code']; } ?>">
        ...
        <p class="et_pb_contact_field ui-sortable et_pb_contact_field_last" data-type="checkbox">
				<span class="et_pb_contact_field_options_wrapper">
						<span class="et_pb_contact_field_options_list"><span class="et_pb_contact_field_checkbox">
							<input type="checkbox"onChange="validate()" id="agreement_page_id" name="agree"class="input" value="yes" <?php if(!empty($_REQUEST['agree']) && $_REQUEST['agree'] == 'yes') { echo 'checked'; } ?>>
