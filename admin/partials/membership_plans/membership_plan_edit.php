...
<div class="wrap" id="member_edit">
    ...
    <?php if (!empty($membershipPlan)) {?>
            ...
            <div class="postbox" id="heading">
                <h1><strong>Membership Plan - </strong><?php echo $membershipPlan->membership; ?></h1>
            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><strong><label for="membership">Membership</label></strong><br>
                                                        <input type="text" name="membership" value="<?php echo $membershipPlan->membership; ?>" required><br>
                                                    ...
                                                    <td><strong><label for="country">Type</label></strong><br>
                                                        <select name="type" class="postform" required style="width: 100%;">
                                                            ...
                                                            <option class="level-0" <?php if ($key == $membershipPlan->type) { echo 'selected'; } ?> value="<?php echo $key; ?>"><?php echo $type; ?></option>
                                                            <?php } ?>
                                                ...
                                                <tr>
                                                    <td><strong><label for="fee">Fee</label></strong><br>
                                                        <input type="text" name="fee" value="<?php echo $membershipPlan->fee; ?>" required><br>
                                                        <error><?php if (!empty($errors['fee'])) {echo $errors['fee'];} ?></error>
                                                    </td>
                                                    <td><strong><label for="total_days">Duration (In days)</label></strong><br>
                                                        <input type="text" name="total_days" value="<?php echo $membershipPlan->total_days; ?>" required><br>
                                    ...
                                    <div class="inside">
                                        <table class="form-table" role="presentation">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <input type="radio" id="activate" class="idDeleted" name="status" value="1" <?php if ($membershipPlan->status == 1) { echo 'checked'; }  ?>>
                                                      <label for="html">Activate</label>
                                                      <input type="radio" id="deactivate" class="idDeleted" name="status" value="0" <?php if ($membershipPlan->status == 0) {echo 'checked';}  ?>>
