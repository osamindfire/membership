                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><strong><label for="primary_phone_no">Phone(Primary)</label></strong><br>
                                                            <input type="text" name="primary_phone_no" value="<?php echo $val->primary_phone_no; ?>" required><br>
                                                        ...
                                                        <td><strong><label for="secondary_phone_no">Phone(Secondary)</label></strong><br>
                                                            <input type="text" name="secondary_phone_no" value="<?php echo $val->secondary_phone_no; ?>" required><br>
                                                        </td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php foreach ($parents as $parent) { ?>
                                                            <td><input type="text" name="spouse_first_name" value="<?php echo $parent->first_name; ?>"><br>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php foreach ($parents as $parent) { ?>
                                                            <td><input type="text" name="spouse_last_name" value="<?php echo $parent->last_name; ?>"><br>
                                        ...
                                        <div class="inside">
                                            <table class="form-table" role="presentation">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                      <input type="radio" id="activate" class="idDeleted" name="is_deleted" value="0" <?php if($val->is_deleted == 0){ echo 'checked' ;}  ?> >
                                                      <label for="html">Activate</label>
                                                      <input type="radio" id="deactivate" class="idDeleted" name="is_deleted" value="1" <?php if($val->is_deleted == 1){ echo 'checked' ;}  ?> >
