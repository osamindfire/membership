                                        ...
                                        <table class="form-table" role="presentation">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><strong><label for="country">Membership Plan</label></strong><br>
                                                        <select name="membership_type" id="membership_type_id" class="postform" required style="width: 100%;">
                                                            ...
                                                            <option class="level-0" value="<?php echo $plan->membership_type_id; ?>" <?php if(isset($_POST['membership_type']) && $_POST['membership_type'] == $plan->membership_type_id ) { echo "selected";}?>><?php echo $plan->membership; ?></option>
                                                            <?php } ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><strong><label for="transaction_id_and_check_no">Transaction Id / Check No.</label></strong><br>
